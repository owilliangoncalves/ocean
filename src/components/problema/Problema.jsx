...
=======
        ...
        <img
          ...
          alt=''
          className='object-none w-full h-[470px]'
        />
      </section>
      <section className='max-w-4xl mx-auto mt-8'>
        <div className='text-2xl mb-4'>
        ...
        <p>
          ...
          principais contribuintes marítimos da poluição dos oceanos.
        </p>
>>>>>>> willian
      </section>
    </div>
